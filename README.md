...
![Team Differential](PNG%20Files/TeamDifferential.png)
...
![Season by Season Trend](PNG%20Files/SeasonBySeasonTrend.png)

### Page 3 — Deep Dive Analysis
*Penalty type breakdown by team + high leverage 4th quarter analysis + Lions spotlight*

![Deep Dive](PNG%20Files/Deep%20Dive.png)

---

## Data Sources

| Source | Description | Seasons |
|--------|-------------|---------|
| [NFLPenalties.com](https://www.nflpenalties.com) | Season-level penalty summary by team — against count, beneficiary count, net yards, home/away splits | 2016–2025 |
| [nflverse (nflfastR)](https://github.com/nflverse/nflverse-data) | Play-by-play data — every penalty play with quarter, score differential, win probability, and penalty type | 2016–2025 |
...
| Tool | Purpose |
|------|---------|
| **Python (pandas)** | Data cleaning, combining 10 seasons of play-by-play CSVs, franchise relocation fixes (OAK→LV, SD→LAC) |
| **SQLite / DB Browser** | Data transformation, aggregation, and query building |
| **Power BI Desktop** | Interactive dashboard — 3 pages, 6 visualizations, conditional formatting, slicers |
| **Google Sheets** | Manual data collection from NFLPenalties.com across 10 seasons |
...
| Project | Topic | Tools |
|---------|-------|-------|
| Project 1 | Video Game Sales Analysis | SQL · Power BI |
| **Project 2** | **NFL Penalty Bias Analysis** | **Python · SQL · Power BI** |
| Projects 3–5 | Coming Soon | Tableau · Python · and more |
